...
export const theme = {
  ...
  // ========================================
  pins: {
    // Pin size (width in pixels) - height is calculated proportionally
    size: 45, // Default: 45px (try values between 30-60 for best results)
  ...
  // ========================================
  header: {
    // Background gradient (top and bottom colors) — semi-opaque so text stays readable over the map
    backgroundStart: "rgba(44, 62, 80, 0.95)", // Dark blue-gray
    backgroundEnd: "rgba(44, 62, 80, 0.8)",

...
import { danceLocations } from './data/danceLocations'
import { musicLocations } from './data/musicLocations'
...
function App() {
  ...
  // Combine dance and music locations
  const allLocations = [...danceLocations, ...musicLocations]
  ...
  useEffect(() => {
    ...
    root.style.setProperty('--btn-hover-bg', theme.timelineButton.hoverBackground);
    ...
    root.style.setProperty('--card-dance-header', theme.card.danceHeaderBackground);
    root.style.setProperty('--card-music-header', theme.card.musicHeaderBackground);
      ...
      <header className="app-header">
        <div className="header-content">
          ...
          <button 
            ...
            aria-label={showSlider ? 'Hide timeline filter' : 'Show timeline filter'}
          >
